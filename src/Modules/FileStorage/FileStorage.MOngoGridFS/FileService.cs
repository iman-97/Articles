...
public class FileService : IFileService
{
    ...
    private const string ContentTypeMetadataKey = "contetntType";
    ...
    public async Task<UploadResponse> UploadFileAsync(string filePath, IFormFile file,
        bool overwrite = false, Dictionary<string, string>? tags = null)
    {
    ...
    {
        if (ObjectId.TryParse(fileId, out var objectId) == false)
